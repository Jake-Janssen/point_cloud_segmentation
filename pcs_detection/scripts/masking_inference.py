...
if __name__ == '__main__':
  ...
  with open(dir_path + '/data/weights/Hood_label_fcn8_LAB_19_12_09_190846/full_config.json') as json_data_file:
  ...
  # Load the image
  input_image = cv.imread('/mnt/project_share/Rars/new_val_4/positives/visible/frame0597.jpg')
